...
export default function ProjectDetails() {
  ...
  const openUrl = async (url: string) => {
    try {
      ...
      if (supported) {
        ...
        Alert.alert("Unable to Open", "This link cannot be opened.");
      }
    } catch (error) {
  ...
  const guideAttachmentNames = Array.isArray(
    ...
    >
      ...
      <View style={styles.section}>
        ...
        {guideAttachmentUrls.length > 0 ? (
          <View style={styles.guideAttachmentsSection}>
            ...
            <Text style={styles.attachmentsDescription}>
              These screenshots show the areas that require changes or
              improvement.
            </Text>
      ...
      {project.status === "revision_required" ? (
        <View style={styles.revisionSection}>
          ...
          <Text style={styles.revisionMessage}>
            Review the guide's feedback and screenshots, make the required
            changes, and submit a new revision.
          </Text>
